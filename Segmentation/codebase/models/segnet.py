...
from .resnet50 import seg_hrnet
...
def segnet(n_classes, input_height=224, input_width=224, encoder_level=3):
...
def resnet50_segnet(n_classes, input_height=416, input_width=608,
                    encoder_level=3):
    model = _segnet(n_classes, seg_hrnet, input_height=input_height,
                    input_width=input_width, encoder_level=encoder_level)
